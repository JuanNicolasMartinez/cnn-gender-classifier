...
import { TimelineModalContent } from "@/components/timeline-modal-content";
...
export function TimelineTrack({ nodes }: TimelineTrackProps) {
    ...
    <>
      ...
      {selectedNode ? (
        <>
          ...
          <div className="fixed inset-x-0 top-1/2 z-[80] mx-auto w-[min(95vw,82rem)] -translate-y-1/2 px-3">
            <div
            ...
            >
              ...
              <TimelineModalContent node={selectedNode} />
            </div>
          </div>
        </>
      ) : null}
